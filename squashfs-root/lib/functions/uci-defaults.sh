...
ucidef_set_interface_lan() {
	...
	config_get def_ip default_ip ip '192.168.1.1'
...
set network.wan.ignore='1'
set network.wan.mac_addr=' '
set network.wan.dns_opt='0'
set network.wan.pppoe_dns_mode='0'
set network.wan.dhcp_dns_mode='0'
set network.wan.macoperate='1'
set network.wan.mtu='1500'
set network.wan.ignore_mtu_change_pppoe='0'
set network.wan.DiaMode='0'
...
set network.$ifname.mac_addr='$mac'
EOF
}
